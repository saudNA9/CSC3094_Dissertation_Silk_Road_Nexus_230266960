...
export const SILK_ROAD_ENTITIES: SilkRoadEntity[] = [
  {
    ...
    startYear: -202,
    endYear: 1500,
    description: `Han and Tang dynasty capital; eastern terminus of Northern Silk Road. Population exceeded 1 million in Tang period. Administrative heart of Han diplomacy with Central Asia.`,
    importance: "Major",
  ...
  },
  {
    ...
    startYear: -200,
    endYear: 1400,
    description: `Desert oasis garrison; controls Jade Gate pass. Mogao Caves library (Cave 17) sealed c.1000 CE contains 50,000 manuscripts in 7+ languages.`,
    importance: "Major",
    source: "Frankopan (2015) ; Pleiades (2025)",
  ...
  },
  {
    ...
    startYear: -200,
    endYear: 1400,
    description: `Oasis city on northern Tarim route. Karez underground irrigation enables settlement. Multi-ethnic Buddhist, Zoroastrian, Nestorian, and Muslim communities.`,
    importance: "Regional",
  ...
  },
  {
    ...
    startYear: -200,
    endYear: 1500,
    description: `Supreme junction of Silk Roads where Northern and Southern routes diverge. Sunday Bazaar tradition spans 2,000 years. Karakhanid Islamic centre from 10th century.`,
    importance: "Major",
  ...
  },
  {
    ...
    startYear: -300,
    endYear: 1500,
    description: `Archetypal Silk Roads city. Samanid intellectual capital; Timurid showcase (Registan, 14th–15th c.). Home of Ibn Sina. Captured by Alexander 329 BCE, Genghis 1220 CE, Timur 1370 CE.`,
    importance: "Major",
    source: "Frankopan (2015) ; Encyclopaedia Iranica",
  ...
  },
  {
    ...
    startYear: -300,
    endYear: 1500,
    description: `Samanid dynasty capital (819–999 CE); Islamic intellectual rival to Baghdad. Ibn Sina educated here. Friday Mosque (10th c.) surviving monument.`,
    importance: "Major",
    source: "Frankopan (2015) ; Encyclopaedia Iranica",
  ...
  },
  {
    ...
    startYear: -300,
    endYear: 1300,
    description: `One of oldest continuously inhabited cities. Seljuq peak: among top 5 Islamic cities. Mongol sack 1221 CE causes catastrophic depopulation. Archaeological layers span 4,000 years.`,
    importance: "Major",
    source: "Frankopan (2015) ; Encyclopaedia Iranica",
  ...
  },
  {
    ...
    startYear: 400,
    endYear: 1500,
    description: `Ilkhanate capital; most cosmopolitan medieval market. Venetian and Genoese colonies resident. Marco Polo and Ibn Battuta both visit and describe legendary bazaar.`,
    importance: "Major",
    source: "Frankopan (2015); Encyclopaedia Iranica",
  ...
  },
  {
    ...
    startYear: 762,
    endYear: 1450,
    description: `Abbasid capital founded 762 CE (City of Peace). House of Wisdom intellectual centre. Mongol sack 1258 CE marks symbolic end of Islamic golden age.`,
    importance: "Major",
  ...
  },
  {
    ...
    startYear: -300,
    endYear: 1268,
    description: `Hellenistic foundation 300 BCE; 3rd largest city in ancient world. Byzantine-Islamic frontier zone. Crusader Principality 1098–1268 CE. Mamluk destruction 1268 CE.`,
    importance: "Regional",
    source: "Frankopan (2015); Pleiades (2025)",
  ...
  },
  {
    ...
    startYear: 330,
    endYear: 1500,
    description: `Byzantine capital from 330 CE; controls Bosphorus. Silk monopoly broken ~550 CE via espionage. Fall to Ottomans 1453 CE triggers European age of exploration.`,
    importance: "Major",
    source: "Frankopan (2015) ; Pleiades (2025)",
    relatedEntities: ["route-northern"],
  ...
  },
  {
    ...
    startYear: 1204,
    endYear: 1461,
    description: `Empire of Trebizond (1204–1461 CE): Black Sea alternative terminus post-Fourth Crusade. Sumela Monastery centre of Byzantine cultural continuity. Genoese trading colony resident.`,
    importance: "Minor",
    source: "Frankopan (2015); Encyclopaedia Iranica",
  ...
  },
  {
    ...
    startYear: -330,
    endYear: 1500,
    description: `Premier Mediterranean port; western terminus of Indian Ocean maritime trade. Library of Alexandria (700,000 manuscripts est.). Pharos Lighthouse — seven wonders. Mamluk spice entrepôt.`,
    importance: "Major",
    source: "Frankopan (2015) ; Pleiades (2025)",
  ...
  },
  {
    ...
    startYear: 700,
    endYear: 1500,
    description: `World's busiest port during Yuan Dynasty (1271–1368 CE). Arab, Persian, Jewish, Indian merchant colonies resident. Marco Polo departs 1291 CE. 100,000+ tons annual cargo.`,
    importance: "Major",
  ...
  },
  {
    ...
    startYear: 100,
    endYear: 1500,
    description: `Controls Strait of Hormuz — mandatory passage for all Persian Gulf maritime trade. Portuguese fortress 1515–1622 CE. Junction of Gulf routes and Indian Ocean maritime network.`,
    importance: "Minor",
    source: "Frankopan (2015); Encyclopaedia Iranica",
    relatedEntities: ["route-maritime"],
    roles: ["Port City", "Trade Hub"],
  ...
  },
  {
    ...
    startYear: 100,
    endYear: 1500,
    description: `Arabian Sea port and monsoon coordination hub. Merchants gather to await seasonal winds to India and Southeast Asia. Arab, Persian, and Indian merchant communities.`,
    importance: "Minor",
    source: "Frankopan (2015); Pleiades (2025)",
